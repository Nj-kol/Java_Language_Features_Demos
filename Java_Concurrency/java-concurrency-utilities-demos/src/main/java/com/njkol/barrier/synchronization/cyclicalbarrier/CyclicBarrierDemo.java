package com.njkol.barrier.synchronization.cyclicalbarrier;
...
public class CyclicBarrierDemo {
	...
	class AggregatorThread implements Runnable {
		...
		public void run() {
			...
			Optional<Integer> sum = partialResults
					                .stream()
					                .flatMap(list -> list.stream())
					                .reduce((a, b) -> a + b);
			
			System.out.println(Thread.currentThread().getName() + ": Final result = " + sum.get());
		}
